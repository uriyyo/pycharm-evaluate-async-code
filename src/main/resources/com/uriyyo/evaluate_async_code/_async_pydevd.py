...
if __name__ == "__main__":
    run_type = os.environ.get("_ASYNC_PY_DEBUG_RUN_TYPE")

    if run_type == "console":
        _pydevd_console_patch()
        from runpy import run_module

        run_module("pydevconsole", {}, "__main__")
    else:
        _pydevd_patch()
        from pydevd import main
